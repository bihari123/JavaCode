public class Narcotic extends Medicine {
     /**
    * @var int id stores the id of the medicine
    * @var int strength stores the narcotic strength of the medicine
     */
    ...
    /** Class constructor
         ...
         * @param strength sets the narcotic strength of the medicine        
         */    

    public Narcotic(String name, double price, double active_substance, int strength) {
...
/**
 * getter method
 * @return the strength of the narcotic medicine
 */
