...
public void removeNotReturn(){
     ...
     public void removeNotReturn(int pos){
  ...
  //Linjen nede er ikke tilgjenglig fordi da blir output til "TestLenkliste"-filen ryddig/lettere å lese.
     ...
     //copy the element of another list into this list
     public void copyElements(Lenkeliste<T> elem) {
        for (T x : elem) {
            leggTil(x);
        }
        }
