...
public class Player implements Runnable{
    ...
    public void newMove(){
       ...
       print("player\'s new position is "+this.place.next.toString());
    ...
    public void run(){
        while(this.place.next!=null){
            lock.lock();
            if(this.human){
                this.terminal.giveStatus(this.getName()+"\'s turn");
            }
            else{
                this.robot.giveStatus(this.getName()+"\'s turn");
            }
            this.newMove();
            lock.unlock();
            //print("unlocked the thread");
        
        }

        if(this.human){
            this.terminal.giveStatus("\n---------------\n"+this.getName()+"\'s thread finished \n------------------\n");
        }
        else{
